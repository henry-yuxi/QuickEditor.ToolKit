...
namespace HananokiEditor {
	...
	public static class EditorExtensions {
		...
		public static string GetShortName( this BuildTargetGroup b  ) {
			if( b == BuildTargetGroup.iOS ) return "iOS";
			if( b == BuildTargetGroup.WSA ) return "UWP";
			return b.ToString();
		}

		public static string GetName( this BuildTargetGroup b ) {
			if( b == BuildTargetGroup.WSA ) return "Universal Windows Platform";
			return GetShortName( b );
		}
